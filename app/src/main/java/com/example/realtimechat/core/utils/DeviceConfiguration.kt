...
enum class DeviceConfiguration {
    ...
    companion object {
        fun fromWindowSizeClasses(windowSizeClass: WindowSizeClass): DeviceConfiguration {
            val widthClass = windowSizeClass.windowWidthSizeClass
            val heightClass = windowSizeClass.windowHeightSizeClass
            return when {
                widthClass == WindowWidthSizeClass.COMPACT &&
                        (heightClass == WindowHeightSizeClass.MEDIUM || heightClass == WindowHeightSizeClass.EXPANDED) -> MOBILE_PORTRAIT

                (widthClass == WindowWidthSizeClass.EXPANDED || widthClass == WindowWidthSizeClass.MEDIUM) &&
